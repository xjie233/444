...
int client_login (int sockfd, int *p_onlinefd, char *username, char *onlinename)
{
	...
	while(1)
	{
		...
		system("tput cup 12 33"); printf("\t*             广 州 大 学 聊 天 系 统 v1.0             *\n");
		...
		switch(a)
		{
			case 1:
				...
				setbuf(stdin,NULL);
				system("stty echo");
				system("tput cup 18 33");  printf("\t正在登录,请稍等...\033[0m\n");
				...
				{
					system("tput cup 20 33");  printf("\033[34;1m您的用户名或密码有误,请重新登录!\033[0m\n");
					system("tput cup 21 33");  printf("\033[34;1m2s后将返回首界面.\033[0m\n");
					sleep(2); 
				}
				break;
			case 2:
					system("clear");
					system("tput cup 11 33"); printf("\t\033[34;1m********************************************************\n");	
					system("tput cup 12 33"); printf("\t*               请    注   册                          *\n");
					system("tput cup 13 33"); printf("\t*------------------------------------------------------*\n");
					system("tput cup 14 33"); printf("\t*             用 户 名:                                *\n");
					system("tput cup 15 33"); printf("\t*------------------------------------------------------*\n");
					system("tput cup 16 33"); printf("\t*             密 码:                                   *\n");
					system("tput cup 17 33"); printf("\t*------------------------------------------------------*\n");
					system("tput cup 18 33"); printf("\t*             确 认 密 码:                             *\n");
					system("tput cup 19 33"); printf("\t********************************************************\n");
					system("tput cup 14 63");
					scanf("%s",rgist.name);
					setbuf(stdin,NULL);
					...
					if(strcmp(rgist.code,code)==0)
					{
						...
						if(flag == 1)//注册成功;
						{
							system("tput cup 22 33"); printf("注册成功!\n");
						}
						else //用户重复注册;
						{
							system("tput cup 22 33"); printf("\033[34;1m该用户已被注册!\033[0m\n");
							//sleep(2);
						}
					}
					else{
						system("tput cup 22 33"); printf("两次密码不一致!请重新输入!\n");
					}
				sleep(2);
				break;
			case 3:
	...
	system("tput cup 0 33");  printf("\033[32;1m登录成功\033[0m\n");
	system("reset");
	system("tput cup 1 33");  printf("\t\t\033[34;1m“%s” \033[0m\033[32;1m你好!\033[0m\n",username);
	system("tput cup 3 33");  printf("\033[32;1m--------------------使用说明--------------------\n");
	system("tput cup 4 33");  printf("私人聊天模式->格式为 聊天对象名:\033[0m\033[34;1m聊天内容\033[0m\n");
	system("tput cup 5 33");  printf("\033[32;1m多人聊天模式->格式为 对象名:对象名:\033[0m\033[34;1m聊天内容\033[0m\n");
	system("tput cup 6 33");  printf("\033[32;1m群聊聊天模式->格式为 all:\033[0m\033[34;1m聊天内容\033[0m\n");
	system("tput cup 7 33");  printf("\033[32;1m退出聊天－>  \033[0m\033[34;1mquit\033[0m\n");
	system("tput cup 9 33");  printf("\033[32;1m------------------------------------------------\033[0m\n");
	//system("tput cup 8 33");  printf("开始你的聊天吧，祝您聊的愉快...\033[0m\n\n");
...
int main (int argc, char *argv[])
{
	...
	system("tput cup 10 33");  printf("\033[34;1m%s\033[0m\n", onlinename);	//打印在线用户名单
	...
	else	//父进程发送消息（只向该用户的服务器处理程序 发送）	
	{
		...
		while(1)
		{
			...
			if(!strncasecmp(buf, "quit", 4))
			{
				...
				system("tput cup 14 33");  printf("\033[31;1m程序即将退出！再见!\033[0m\n");
				sleep(2);
				system("clear");
				kill(0,SIGKILL);
				//exit(0);
